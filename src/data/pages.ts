...
const pages = {
  fr: {
    ...
    gallery: { title: 'Galerie', description: 'Les opérations et équipes COST en images.', heading: 'Nos opérations sur le terrain', notice: 'Découvrez les opérations, infrastructures et équipes qui accompagnent les flux maritimes et logistiques.', items: ['Opérations maritimes', 'Escale portuaire', 'Manutention', 'Transport routier', 'Installations pétrolières', 'Terminal à conteneurs', 'Opérations portuaires'], socialLinkTitle: 'Nos actions sociales', socialLinkText: 'COST agit aux côtés des communautés. Découvrez en images la réalisation d’un point d’eau communautaire.', socialLinkLabel: 'Voir la galerie' },
    socialGallery: { title: 'Actions sociales', description: 'Les actions sociales menées par COST aux côtés des communautés locales.', eyebrow: 'Engagement communautaire', heading: 'Un point d’eau pour la communauté', notice: 'De l’installation de l’équipement de forage à l’aménagement du point d’eau, découvrez les étapes de cette action menée sur le terrain.', backLabel: 'Retour à la galerie', items: ['Construction de l’abri du point d’eau', 'Aménagement des abords', 'Installation du bassin et de la pompe', 'Mise en place de l’équipement de forage', 'Travaux de forage sur le terrain', 'Engin mobilisé pour le forage', 'Équipe au travail sur le chantier', 'Suivi des travaux avec la communauté'] },
    contact: { 
      title: 'Contact', 
  ...
  en: {
    ...
    gallery: { title: 'Gallery', description: 'COST operations and teams in pictures.', heading: 'Our field operations', notice: 'Explore the operations, infrastructure and teams supporting maritime and logistics flows.', items: ['Maritime operations', 'Port calls', 'Cargo handling', 'Road transport', 'Oil terminals', 'Container terminal', 'Port operations'], socialLinkTitle: 'Our social initiatives', socialLinkText: 'COST works alongside local communities. See the construction of a community water point in pictures.', socialLinkLabel: 'View the gallery' },
    socialGallery: { title: 'Social initiatives', description: 'COST social initiatives carried out alongside local communities.', eyebrow: 'Community commitment', heading: 'A water point for the community', notice: 'From installing the drilling equipment to completing the water point, explore each stage of this field initiative.', backLabel: 'Back to the gallery', items: ['Building the water point shelter', 'Preparing the surrounding area', 'Installing the basin and pump', 'Setting up the drilling equipment', 'Drilling work on site', 'Drilling rig deployed on site', 'Team at work on the site', 'Monitoring the work with the community'] },
     contact: { 
      title: 'Contact', 
