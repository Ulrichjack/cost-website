...
const pages = {
  ...
  en: {
    ...
    gallery: { title: 'Gallery', description: 'COST operations and teams in pictures.', heading: 'Our field operations', notice: 'Explore the operations, infrastructure and teams supporting maritime and logistics flows.', items: ['Maritime operations', 'Port calls', 'Cargo handling', 'Road transport', 'Oil terminals', 'Container terminal', 'Port operations', ] },
     contact: { 
      title: 'Contact', 
