...
const pages = {
  ...
  en: {
    ...
    socialGallery: { title: 'Social initiatives', description: 'COST social initiatives carried out alongside local communities.', eyebrow: 'Community commitment', heading: 'A water point for the community', notice: 'From installing the drilling equipment to completing the water point, explore each stage of this field initiative.', backLabel: 'Back to the gallery', items: ['Installing the water point pump', 'Building the water point shelter', 'Installing the basin and pump', 'Preparing the surrounding area', 'Drilling work on site', 'Setting up the drilling equipment', 'Monitoring the work with the community', 'Team at work on the site'] },
     contact: { 
      title: 'Contact', 
